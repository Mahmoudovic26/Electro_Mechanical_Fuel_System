...
#define R_CLK_SWO_Pin GPIO_PIN_3
#define R_CLK_SWO_GPIO_Port GPIOB
...
#define CTP_RST_R_GPIO1_Pin GPIO_PIN_7
#define CTP_RST_R_GPIO1_GPIO_Port GPIOG
...
#define USB1_OVERCURRENT_R_GPIO0_Pin GPIO_PIN_3
#define USB1_OVERCURRENT_R_GPIO0_GPIO_Port GPIOG
...
#define FDCAN1_STB_Pin GPIO_PIN_1
